...
const zh_tw = {
  translation: {
    ...
    default_value: "預設值",
    check: "檢查表達式",
    this_will_appear_as_is: "*此內容將按原樣顯示在生成的指令碼中。",
    comment: "註解",
    add_field: "新增欄位",
    values: "值",
    size: "大小",
    precision: "精度",
    set_precision: "設定精度：(大小，位數)",
    use_for_batch_input: "用於批次輸入，使用逗號",
    indices: "索引",
    add_index: "新增索引",
    select_fields: "選擇欄位",
    title: "標題",
    ...
    content: "內容",
    types_info:
      "此功能適用於像 PostgreSQL 這樣的物件關係型資料庫管理系統。\n如果用於 MySQL 或 MariaDB，將生成具有相應 JSON 驗證檢查的 JSON 型別。\n如果用於 SQLite，它將被轉換為 BLOB。\n如果用於 MSSQL，將生成到第一個欄位的型別別名。",
    table_deleted: "資料表已刪除",
    area_deleted: "區域已刪除",
    note_deleted: "註解已刪除",
    relationship_deleted: "關聯已刪除",
    type_deleted: "型別已刪除",
    cannot_connect: "無法連接，欄位具有不同的型別",
    ...
    drag_and_drop_files: "拖放檔案到此處或點擊上傳。",
    upload_sql_to_generate_diagrams: "上傳 SQL 檔案以自動生成資料表和欄位。",
    ...
    multiselect: "多重選取",
    templates: "範本",
    database_schema_templates: "資料庫綱要範本",
    database_templates_description: "一系列資料庫實體關係圖，協助您快速開始或為應用程式架構提供靈感。",
    default_templates: "預設範本",
    your_templates: "您的範本",
    fork: "複製",
    no_custom_templates: "您沒有儲存自訂範本。",
    how_to_save_template: "如何儲存範本",
    build_diagram: "建立圖表",
    build_template_description: "在編輯器中建立範本",
    save_as_template_step: "儲存為範本",
    save_as_template_description: "編輯器 > 檔案 > 儲存為範本",
    load_template: "載入範本",
    load_template_description: "複製範本以在其基礎上建立",
    
    // 資料庫範本標題和描述
    blog_database_schema: "部落格資料庫綱要",
    blog_database_schema_description: "一個部落格資料庫，包括用於文章、使用者、評論和標籤等資料表，便於儲存及檢索部落格相關資訊。",
    
    human_resources_schema: "人力資源綱要",
    human_resources_schema_description: "一個為管理公司員工和專案相關資訊而設計的人力資源(HR)綱要。",
    
    ecommerce_schema: "電子商務綱要",
    ecommerce_schema_description: "一個設計用於管理線上商店各方面的電子商務綱要，包括產品、訂單和客戶資訊。",
    
    library_schema: "圖書館綱要",
    library_schema_description: "一個為管理圖書、類型、借閱和其他圖書館系統各方面而設計的綱要。",
    
    bank_schema: "銀行綱要",
    bank_schema_description: "一個為管理金融交易、帳戶、客戶和其他銀行業務而設計的金融綱要。",
    
    university_schema: "大學綱要",
    university_schema_description: "一個為管理學生、課程、教師和其他大學相關資料而設計的教育綱要。",
    
    cmdragon_tools: "更多好用工具",
    
    // 404頁面
    page_not_found: "頁面未找到",
    page_not_found_description: "您查找的頁面不存在或已被移動。",
    back_to_home: "返回首頁",
